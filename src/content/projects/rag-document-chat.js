...
### Current Progress
- Perused hugging face and found some interesting open weights models
- Initialized Python backend with FastAPI.
- Configured document parsing and chunking logic.
